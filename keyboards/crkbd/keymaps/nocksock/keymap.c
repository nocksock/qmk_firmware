...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NUMPAD] = LAYOUT_split_3x6_3(
        XXXXXXX  , XXXXXXX , XXXXXXX , DT_DOWN , DT_UP   , DT_PRNT  , XXXXXXX , KC_7 , KC_8 , KC_9 , XXXXXXX , XXXXXXX  ,
        XXXXXXX , XXXXXXX , OS_ALT  , OS_CTRL , OS_SHFT , OSM_HYPR , XXXXXXX , KC_4 , KC_5 , KC_6 , OS_CMD  , XXXXXXX ,
        XXXXXXX  , XXXXXXX , XXXXXXX , KC_DOT  , KC_COMM , XXXXXXX  , KC_0    , KC_1 , KC_2 , KC_3 , XXXXXXX , XXXXXXX  ,
        _______ , _______ , _______ , _______ , _______ , _______
    ),
