...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [SYM] = LAYOUT(
        _______  , KC_TAB  , KC_AT   , KC_HASH , KC_DLR  , KC_PERC , KC_CIRC , KC_AMPR        , KC_ASTR       , KC_LCBR      , KC_RCBR      , _______  ,
    ...
    [NAV] = LAYOUT(
        _______  , KC_ESC , SW_WIN  , TAB_L   , TAB_R   , XXXXXXX , KC_HOME , KC_PAGE_DOWN , KC_PAGE_UP , KC_END  , KC_DEL  , QK_BOOT   ,
    ...
    [NUMPAD] = LAYOUT_split_3x6_3(
        XXXXXXX , XXXXXXX , XXXXXXX , DT_DOWN     , DT_UP       , DT_PRNT , KC_KP_SLASH    , KC_7 , KC_8 , KC_9 , KC_KP_MINUS , XXXXXXX ,
        XXXXXXX , XXXXXXX , OS_ALT  , KC_KP_MINUS , KC_KP_COMMA , XXXXXXX , KC_KP_ASTERISK , KC_4 , KC_5 , KC_6 , KC_KP_PLUS  , XXXXXXX ,
        XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX     , XXXXXXX     , XXXXXXX , KC_0           , KC_1 , KC_2 , KC_3 , KC_KP_ENTER , XXXXXXX ,
        _______ , _______ , _______ , _______     , KC_KP_DOT   , KC_KP_COMMA
    )           ,
