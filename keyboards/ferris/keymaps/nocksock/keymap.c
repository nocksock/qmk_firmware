...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT( 
      ...
      KC_EQUAL , KC_LBRC , KC_LPRN , KC_RPRN , KC_RBRC , KC_QUOTE , MOD_RSFT , MOD_RCTL , MOD_RALT , MOD_RGUI ,
      KC_GRV   , XXXXXXX , XXXXXXX , XXXXXXX , KC_BSLS ,  XXXXXXX , KC_UNDS  ,  KC_LABK , KC_RABK  ,  KC_SLSH ,
  ...
  [2] = LAYOUT( 
      ...
      MOD_LGUI , MOD_LALT , MOD_LCTL , MOD_LSFT , KC_MPLY , KC_LEFT , KC_DOWN , KC_UP   , KC_RIGHT , KC_DEL,
      XXXXXXX       , XXXXXXX       , XXXXXXX       , XXXXXXX       , XXXXXXX , KC_TAB  , KC_ENT  , XXXXXXX , XXXXXXX  , XXXXXXX,
  ...
  [3] = LAYOUT( 
      ...
      _______ , _______ , _______ , _______ , XXXXXXX , XXXXXXX , RSFT_T(KC_4) , RCTL_T(KC_5) , RALT_T(KC_6) , _______ ,
  ...
  // fkey-layer
  [4] = LAYOUT( 
      XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , QK_BOOT , KC_F12 , KC_F7 , KC_F8 , KC_F9 , XXXXXXX ,
      _______ , _______ , _______ , _______ , QK_REBOOT , KC_F11 , KC_F4 , KC_F5 , KC_F6 , XXXXXXX ,
