...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_ansi_69(
        ...
        KC_HTAB  , KC_Q    , KC_W    , KC_E   , KC_R   , KC_T   , KC_Y    , KC_U    , KC_I    , KC_O    , KC_P    , KC_LBRC , KC_RBRC , KC_BSLS , TG(COLOR) ,
        ...
        KC_MEH  , KC_LOPT , KC_LCMD , KC_SPC , LA_NAV , LA_SYM , KC_RSFT , KC_RCMD , KC_LEFT , KC_DOWN , KC_RGHT
    ) ,
    ...
    [WIN_BASE] = LAYOUT_ansi_69(
        ...
        KC_MEH  , KC_LOPT , KC_LCTL , KC_SPC , LA_NAV , LA_SYM , KC_RSFT , KC_RCMD , KC_LEFT , KC_DOWN , KC_RGHT
    ) ,

    [SYM] = LAYOUT_ansi_69(
        _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,
        RGB_TOG , KC_ESC  , KC_AT   , KC_HASH , KC_DLR  , KC_PERC , KC_CIRC , KC_AMPR , KC_ASTR , KC_LCBR , KC_RCBR  , _______ , _______ , _______ , _______ ,
        _______ , KC_MINS , KC_DQUO , KC_LPRN , KC_RPRN , KC_EQL  , XXXXXXX , OS_SHFT , OS_CTRL , OS_ALT  , OS_CMD  , _______ , _______ , _______ ,
    ...
    [NAV] = LAYOUT_ansi_69(
        _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ , _______ ,
        _______ , KC_TAB  , SW_WIN  , TAB_L   , TAB_R   , XXXXXXX , QK_BOOT , HOME    , KC_CAPS , END     , KC_DEL  , _______ , _______ , _______ , _______ ,
        _______ , OS_CMD  , OS_ALT  , OS_CTRL , OS_SHFT , KC_MNXT , KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT , KC_BSPC , _______ , _______ , _______ ,
